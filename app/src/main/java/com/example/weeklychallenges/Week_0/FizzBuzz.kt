package com.example.weeklychallenges.Week_0

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import com.example.weeklychallenges.R
...
class FizzBuzz : AppCompatActivity() {
    ...
    fun bizzBuzz() {
        for (index in 1..100) {
            val divByThree = index % 3 == 0
            val divByFive = index % 5 == 0
